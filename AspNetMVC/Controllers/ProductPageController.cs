...
namespace AspNetMVC.Controllers
{
    public class ProductPageController : Controller
    {
        ...
        [HttpPost]
        public JsonResult ModifyUserDefinedByUserDefindId(IEnumerable<UserDefinedAll> userDefinedall)
        {
            var UserName = Helpers.DecodeCookie(Request.Cookies["user"]["user_accountname"]);

            if (ModelState.IsValid)
            {
                _productPageService.modifyUserDefined(userDefinedall, UserName);
