        ...
        public List<ServiceItemsViewModel> CreateServicesList()
        {
            return new List<ServiceItemsViewModel>
            {
                new ServiceItemsViewModel
                {
                    ...
                    {
                       new ServiceItemViewModel{ImgUrl="air condtioner",Text="不再網通都有公斤多次進了等等，還沒記錄，網址打擊商標做出實。",Title="冷氣機清潔",Url="../DetailPage/Index/1"},
                       new ServiceItemViewModel{ImgUrl="kitchen",Text="不再網通都有公斤多次進了等等，還沒記錄，網址打擊商標做出實。",Title="廚房清潔",Url="../DetailPage/Index/2"},
                       new ServiceItemViewModel{ImgUrl="wash machine",Text="不再網通都有公斤多次進了等等，還沒記錄，網址打擊商標做出實。",Title="洗衣機清潔",Url="../DetailPage/Index/3"}
                    },
                },
                new ServiceItemsViewModel
                {
                ...
                new ServiceItemsViewModel
                {
                    ...
                    {
                       new ServiceItemViewModel{ImgUrl="bed",Text="不再網通都有公斤多次進了等等，還沒記錄，網址打擊商標做出實。",Title="床墊清潔",Url="../DetailPage/Index/4"},
                       new ServiceItemViewModel{ImgUrl="water pip",Text="不再網通都有公斤多次進了等等，還沒記錄，網址打擊商標做出實。",Title="水管清潔",Url="../DetailPage/Index/5"},
                       new ServiceItemViewModel{ImgUrl="wall",Text="不再網通都有公斤多次進了等等，還沒記錄，網址打擊商標做出實。",Title="壁癌處理",Url="../DetailPage/Index/6"}
                    },
                },
                new ServiceItemsViewModel
                {
